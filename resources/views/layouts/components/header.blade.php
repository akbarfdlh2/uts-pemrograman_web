                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col ml--2">
                      <div class="d-flex justify-content-between align-items-center">
                        <div>
                          <h4 class="mb-0 text-sm">Muhamad Akbar Fadilah</h4>
                        </div>
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img src="{{ asset('assets/img/theme/photo_profile_default_primary.png')}}" class="Image placeholder">
                </span>
                <div class="media-body  ml-2  d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold">Muhamad Akbar Fadilah</span>
                </div>
              </div>
            </a>
